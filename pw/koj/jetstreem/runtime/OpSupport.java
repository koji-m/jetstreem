    ...
    static {
        try {
            ...
            BINARY_OP = lookup.findStatic(
                OpSupport.class,
                "binaryOp",
                methodType(Object.class, StrmCallSite.class, String.class, Object.class, Object.class));
/*
    ...
    public static Object unaryOp(StrmCallSite callSite, String name, Object operand) throws Throwable {
        MethodHandle mh;
        ...
        return mh.invokeExact(operand);
    }

    public static Object binaryOp(StrmCallSite callSite, String name, Object lhs, Object rhs) throws Throwable {
